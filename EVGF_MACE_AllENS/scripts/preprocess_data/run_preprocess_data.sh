...
BENCHMARK_HOME="/data1/project/yewon/MLFF-Framework"
...
# python preprocess.py \
#     --train-data /data1/project/yewon/MLFF-Framework_MACE/datasets/HfO/Trainset.xyz \
#     --train-data-output-name train \
#     --valid-data /data1/project/yewon/MLFF-Framework_MACE/datasets/HfO/Validset.xyz \
#     --valid-data-output-name valid \
#     --test-data /data1/project/yewon/MLFF-Framework_MACE/datasets/HfO/Testset.xyz \
#     --test-data-output-name test \
#     --out-path /data1/project/yewon/MLFF-Framework_MACE/datasets/HfO \
#     --r-max 6.0 \
#     --max-neighbors 50
