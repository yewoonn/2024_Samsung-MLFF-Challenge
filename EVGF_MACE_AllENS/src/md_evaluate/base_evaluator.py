...
class BaseEvaluator:
    def __init__(self, config):
        ...
        self.ckpt_list = [
            "/data1/project/yewon/MLFF-Framework_MACE/train_results/HfO/MACE/checkpoints/train-20240907_152048/best_checkpoint.pt",
            "/data1/project/yewon/MLFF-Framework_MACE/train_results/HfO/MACE/checkpoints/train-20240907_152048/ckpt_ep60.pt",
        ]
