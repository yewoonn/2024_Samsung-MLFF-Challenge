...
class BaseEvaluator:
    def __init__(self, config):
        ...
        self.ckpt_list = [
            "/data1/project/yewon/Samsung_MLFF_Models/MACE_AllENS/train_results/HfO/MACE/checkpoints/train-20240908_062602/best_checkpoint.pt",
            "/data1/project/yewon/Samsung_MLFF_Models/MACE_AllENS/train_results/HfO/MACE/checkpoints/train-20240908_062602/checkpoint.pt",
        ]
